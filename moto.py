...
def display_statistics(filtered_data, period):
    ...
    if period == 'day':
        ...
        # Ensure week starts on Monday and ends on Sunday
        filtered_data['Week_Start'] = filtered_data['Ngày'].dt.to_period('W').apply(lambda r: r.start_time)
